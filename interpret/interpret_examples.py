...
def main():
    ...
    # attributions = dls.interpret(pred_point_id=(200, 205), num_baselines=100)
    
    # # Example - attribution matrix for pred point 202 and output element (0,1)
    # print(attributions.keys())
    # print(attributions[202][(0,1)]['attributions'])
    ...
    attributions = dls.interpret(pred_point_id=200, baseline_mode='random')
    
    # Example - attribution matrix for pred point 202 and class 1
    print(attributions.keys())
    print(attributions[202][(0,1)]['attributions'])
