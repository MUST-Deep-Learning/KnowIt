...
#                                           split_portions=(0.6, 0.2, 0.2), seed=666, batch_size=64, limit=50000,
...
# import numpy as np
#
# def get_model(train_device, in_dim, out_dim):
#     my_network = mlp(in_dim, out_dim,
...
# my_network = get_model(train_device, in_dim, out_dim)
